    ...
    public function create(Annonce $annonce = null, Request $request, EntityManagerInterface $manager)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            if (!empty($ext2['Image'])) {
                ...
                rename('D:/www/Le_bon_souk-master/a/public/uploads/' . $id . "/" . $originalFilename, 'D:/www/Le_bon_souk-master/a/public/uploads/' . $id . "/" . $originalFilename . "." . $ext);
 ...
 */
     ...
     */
    public function showAnnonce(EntityManagerInterface $em)
    {
        $annonce = new Annonce();
        $repository = $em->getRepository(Annonce::class);
